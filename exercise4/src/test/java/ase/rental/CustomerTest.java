...
class CustomerTest {
  ...
  void creation() {
    ...
    assertThat(html, containsString("Rental record for John Smith"));
    assertThat(html, containsString("Amount owed is £0"));
    assertThat(html, containsString("You earned 0 frequent renter points"));
  }
